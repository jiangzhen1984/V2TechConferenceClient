...
import com.bizcom.vc.listener.CommonCallBack.CommonNotifyCrowdDetailNewMessage;
...
//		mNoTV.setText(cid.length() > 4 ? cid.substring(5) : cid.substring(1));
		...
		if(isFriend && !TextUtils.isEmpty(crowd.getOwnerUser().getCommentName()))
			mCreatorTV.setText(crowd.getOwnerUser().getCommentName());
		else
