	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case NORMAL_SELECT_FILE:
			...
			if (mCheckedList != null && mCheckedList.size() > 0
				...
				selectedFileSize
						.setText(R.string.conversation_select_file_entry_chosen
								+ getFileSize(totalSize));
				sendButton.setText(R.string.conversation_select_file_entry_send
						+ mCheckedList.size()
						+ R.string.conversation_select_file_entry_brackets);
