package com.v2tech.view.cus.switcher;
...
public class Switch extends CompoundButton
{
	...
	private Layout makeLayout(CharSequence text)
	{
		...
		return new StaticLayout(transformed, mTextPaint, (int) java.lang.Math.ceil(Layout.getDesiredWidth(transformed, mTextPaint)), Layout.Alignment.ALIGN_NORMAL, 1.f, 0, true);
	}
